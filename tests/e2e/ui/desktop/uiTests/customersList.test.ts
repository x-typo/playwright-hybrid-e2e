import { test, expect } from "../../../../../common/automation-fixtures";
...
test.describe("Table View", () => {
  ...
  test("Page Validation", async ({ customersListPage }) => {
  ...
  test(
    ...
    async ({ page, customersListPage, navigationDrawer }) => {
  ...
  test.skip(
    ...
    async ({ customersListPage, performAccessibilityScan }) => {
      const customerName = "aQA_Test_Customer";
      const rowLink = {
        name: customerName,
        link: customerName,
  ...
  test("'Add Customer' Button", async ({ customersListPage }) => {
  ...
  test("Search", async ({ customersListPage }) => {
    const searchData = {
  ...
  test("Table Tools", async ({ customersListPage }) => {
    await test.step("Verify", async () => {
